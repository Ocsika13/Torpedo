    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Print_BattleField(Letter_Fields, battlefield_Player);
                Console.WriteLine();
                Console.WriteLine("CPU/Player 2 Fields");
                Print_BattleField(Letter_Fields, battlefield_CPU_Show);
                if (player_Num == 1)
                {
        ...
        public static void Battle_Start_Counter()
        {
            ...
            Random_Battlefield_Generator(battlefield_Player);
            Random_Battlefield_Generator(battlefield_CPU);
        }
